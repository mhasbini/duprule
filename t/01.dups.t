...
my @ok_pairs = (	['cl', 'l'], ['cu', 'u'], ['C', 'uC'], ['rr', ':'], ['r', 'rrr'], ['lt', 'u'], ['tt', ':'],
				...
				['{{{{}}}}', ':'], ['] { [ }', 'D1]', '],1['], ['^a[', ':'], ['^a^bl[[', 'l'], ['$a$b]]c', 'c'], ['[', 'D0'], ['O02', 'D0D0'],
